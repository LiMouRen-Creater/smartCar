...
def generate_launch_description():
    return LaunchDescription([
        ...
        # REVERSE_TURN
        DeclareLaunchArgument('reverse_turn_angle',  default_value='1.50'),
        ...
        DeclareLaunchArgument('yellow_enter_x', default_value='0.15'),
        # YELLOW_FOLLOW
        DeclareLaunchArgument('yellow_x',  default_value='0.5'),
        DeclareLaunchArgument('yellow_kp', default_value='0.004'),
        DeclareLaunchArgument('yellow_kd', default_value='0.0005'),
        # EXIT_CHANNEL
        ...
        Node(
            ...
            parameters=[{
                ...
                "yellow_enter_x": LaunchConfiguration('yellow_enter_x'),
                'yellow_x':  LaunchConfiguration('yellow_x'),
                'yellow_kp': LaunchConfiguration('yellow_kp'),
                'yellow_kd': LaunchConfiguration('yellow_kd'),
