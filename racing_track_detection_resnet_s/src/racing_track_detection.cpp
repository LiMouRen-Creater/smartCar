...
TrackDetectionNode::TrackDetectionNode(const std::string& node_name,
  ...
  publisher_ =
    this->create_publisher<ai_msgs::msg::PerceptionTargets>("racing_track_center_detection_s", 1);
  subscriber_hbmem_ =
...
int main(int argc, char* argv[]) {
  ...
  rclcpp::spin(std::make_shared<TrackDetectionNode>("GetLineCoordinate_s"));
