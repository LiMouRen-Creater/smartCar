...
def generate_launch_description():
    ...
    web_show_yolo = os.getenv('WEB_SHOW_YOLO')#export WEB_SHOW_YOLO=TRUE
    print("web_show_yolo is ", web_show_yolo)
    ...
    web_node = IncludeLaunchDescription(
        ...
        launch_arguments={
            'websocket_image_topic': '/img_decode',
            'websocket_smart_topic': '/racing_obstacle_detection',
            'websocket_smart_qos': 'best_effort'
        }.items()
    )
